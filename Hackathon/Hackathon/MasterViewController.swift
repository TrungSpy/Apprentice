...
class MasterViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = (detailViewController?.marker.title)! + (",") + (detailViewController?.marker.position.latitude.description)! + (",") + (detailViewController?.marker.position.longitude.description)!
